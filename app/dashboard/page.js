    ...
    <div style={{ minHeight: "100vh", background: "#05060a", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ display: "flex", position: "relative", zIndex: 2 }}>
        ...
        <div style={{
          ...
          <div style={{ marginTop: 32, padding: "14px", borderRadius: 12, background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)" }}>
        ...
        {/* Main content */}
        <div style={{ flex: 1, padding: "2.5rem 3rem", maxWidth: 1100 }}>
          <div style={{ marginBottom: "2rem" }}>
            <h1 style={{ fontSize: 28, fontWeight: 800, margin: "0 0 6px", color: "#fff" }}>Every day is a new adventure.</h1>
